...
<div id="history_area" style="overflow:hidden; height:0px; width:100%;"></div>
<script>
	$('#code_area').css('overflow','hidden');
	$('#code_area').height(0);
	$('#r2_area').css('overflow','hidden');
